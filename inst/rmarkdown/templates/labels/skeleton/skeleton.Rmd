...
\fontsize{12pt}{12pt}
`r data$Family`  
`r writer(paste(data$Genus, data$Epithet), italics = TRUE)` `r data$Binomial_authority` `r writer(data$Infrarank)` `r writer(data$Infraspecies, italics = TRUE)` `r data$Infraspecific_author` 
