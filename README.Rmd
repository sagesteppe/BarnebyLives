...
cat(
  badger::badge_github_actions("lint", "sagesteppe/BarnebyLives"),  "\n",
	badger::badge_codefactor('sagesteppe/BarnebyLives'),  "\n",
	badger::badge_repostatus("Active"),  "\n",
  badger::badge_github_actions("R-CMD-check", "sagesteppe/BarnebyLives")
)
```
...
![Flowchart showing BarnebyLives workflow from field data collection through label generation and herbarium export. Steps include: input specimen data, run query functions, generate political/geographic/taxonomic metadata, create labels, and export to multiple herbarium formats](reference/figures/workflow.png)
...
| ![Oil portrait of botanist Rupert Charles Barneby painted by Dwight Ripley in 1955, showing Barneby in contemplative pose against a warm background](man/figures/barneby-portrait.jpg) | 
|:--:| 
