...
![Flowchart showing BarnebyLives workflow: Input field data → Query functions → Generate labels → Export to herbarium formats](reference/figures/workflow.png)
...
| ![Portrait painting of Rupert Barneby by Dwight Ripley from 1955, showing the botanist in contemplative pose](man/figures/barneby-portrait.jpg) | 
|:--:| 
