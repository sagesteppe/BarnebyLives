...
First the script will install WSL, then you will need to restart and run the script again. 
...
Then, run the script again to complete the installation process.
