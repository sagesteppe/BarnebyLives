...
We can download a static copy of the data from Kews data portal at: http://sftp.kew.org/pub/data-repositories/WCVP/. It is not that large of a file, so it should come ver in a couple minutes. 

```{r read in WCVP data, eval = F}

p2 <- '/home/sagesteppe/Documents/assoRted/Barneby_Lives_dev/wcvp'
