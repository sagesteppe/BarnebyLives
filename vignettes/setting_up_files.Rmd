...
abbrevs$author_abbrevation <- sub('\\.$', '', abbrevs) # remove the trailing periods
abbrevs$author_abbrevation <- sub('\\.(?!.*\\.)', ". ", 
    abbrevs$author_abbrevation, perl = T) # identify the last period in the name, and add a space after it

head(abbrevs$author_abbrevation)
#abbrevs$author_abbrevation <- paste0(abbrevs$author_abbrevation, trailed, collapse = "")
