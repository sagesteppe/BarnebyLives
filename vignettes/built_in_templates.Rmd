...
For example 1) `maps`, 2) `logos` are treated in `Labels with graphics`, and customizing two additional basic skeletons is treated in 3) `custom label fonts`. 
...
## Seeds of Success label

The SOS label was actually the original label, and is clearly closely related to the Scientific label. 

![*Seeds of Success *](../man/figures/default-SOS-2823-1.png)  

default-SOS-2823-1.png
