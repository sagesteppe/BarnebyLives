...
Several spreadsheet softwares auto-increment numeric columns by default. We try to identify that issue here. 
```{r check for autofill on coords}
...
```{r drop focal species from associated species}
