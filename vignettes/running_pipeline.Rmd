...
gs4_auth(email = gargle::gargle_oauth_email("reedbenkendorf27@gmail.com"))
...
For internal usage and data acquisition we will make dataset explicitly spatial, rather than just holding coordinates in a column. 
...
```{r check spelling of binomial and family}
spell_check()
```
...
```{r check spellings of vegetation and associated species}
