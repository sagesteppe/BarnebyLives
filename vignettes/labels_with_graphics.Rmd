---
title: "Labels with graphics"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Labels with graphics}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
description: >
  Using the label templates which allow you to embed, grphics, such as maps or logos onto them.  
---
...
Going through `Customizing a label template` before this vignette may be useful. 
...
purrr::walk(
  ...
  .f = function(x) {
    rmarkdown::render(
      ...
      output_file = file.path(local, as.character(glue::glue("map{x}.pdf"))),
      params = list(
        Collection_number = x,
...
PLEASE NOTE that the `[5]` argument refers to the number of lines of text the image is expected to span. 
People using a smaller font may need to kick that up a notch to `[6]`S. 
