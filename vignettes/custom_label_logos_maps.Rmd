...
map_maker(
  ...
  path_out = file.path(local, 'maps'), # where the map will be saved 
...
purrr::walk(
  ...
  ~ rmarkdown::render(
    ...
    params = list(
      Collection_number = .x, 
      imagepath = '~/Documents/assoRted/Barneby_Lives_dev/LabelStyles/maps'
      ) 
   )
)
```
...
![Map](../man/figures/Map2-2823.png)  

# Logos

adding logos or other images to labels is even simpler. 
